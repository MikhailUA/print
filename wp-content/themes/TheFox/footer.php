...
<script type="text/javascript">$('.ui-slider-handle').draggable();</script>
...
<script>
    ...
    $("#product-gallery .thumbs a:first").addClass("active");

    $("#product-gallery .thumbs a").each(function(i) {
        $(this).addClass("pic" + (i+1));
    });

    $("#product-gallery .thumbs a").mouseover(function() {
        $("#product-gallery a").removeClass("active");
        $(this).addClass("active");
        var imgThumbHref = $(this).attr("name");
        var imgThumbNumber = $(this).attr("class").split(' ')[1];
        $('#product-gallery > .main-image img').attr("src", imgThumbHref).attr("class", imgThumbNumber);
    });

    $("#product-gallery > .main-image").hover(function() {
        $(".i-magnif-2").show();
