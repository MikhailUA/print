...
$step_position = $component_data[ 'position' ];
...
?><li class="component_option_thumbnail_container <?php echo $thumbnail_class; ?>">
	<div id="component_option_thumbnail_<?php echo $product_id; ?>" class="cp_clearfix component_option_thumbnail disabled <?php echo $selected; ?>" data-val="<?php echo $product_id; ?>">
		...
		<div class="image thumbnail_image" title="<?php echo esc_attr( $product_title ); ?>">
            <?php
			if ( has_post_thumbnail( $product_id ) ) {
				echo get_the_post_thumbnail( $product_id, apply_filters( 'woocommerce_composite_component_option_image_size', 'component_type_image' ) );
			} else {
