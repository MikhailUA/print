...
<!--<script src="<?php /*echo get_template_directory_uri(); */?>/js/jquery.range.js"></script>-->
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/js/jquery.range.css">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/zago-font.css">

<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style1.css">
<link href="https://plus.google.com/115272856751778112670" rel="publisher" />
    <!-- New styles -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/whitelabel/css/normalized680.css?v20160919" media="screen"/>

    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/whitelabel/css/styled680.css?v20160919" media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/whitelabel/css/style-responsived680.css?v20160919" media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/whitelabel/css/jquery.mmenu.all.css" media="screen"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/whitelabel/css/style_segment_control.css" media="screen"/>

    <link rel="canonical" href="visitekaartjes-drukken.html"/>


<!--    <script>
        if (typeof jQuery == 'undefined') {
            document.write('<script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/jquery-1.9.1.min.js"><\/script>');
        }
    </script>

    <script src="<?php /*echo get_template_directory_uri();*/?>/js/jquery/jquery-1.7.2.min.js"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/js/jquery/plugins/jquery.easing.js"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/js/tools.js"></script>

    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/tools.js"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/jquery.fancybox.js"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/js.cookied680.js?v20160919"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/main.v2d680.js?v20160919"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/searchd680.js?v20160919"></script>
    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/prooflinkd680.js?v20160919"></script>

    <script src="<?php /*echo get_template_directory_uri(); */?>/whitelabel/js/extrascript-UA.js"></script>-->


    <script src="<?php echo get_template_directory_uri();?>/js/jquery/jquery-1.7.2.min.js"></script>
    <script src="<?php echo get_template_directory_uri();?>/js/jquery/plugins/jquery.easing.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/whitelabel/js/jquery.fancybox.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/whitelabel/js/jquery.fancybox-thumbs.js"></script>
...
<?php } ?>
 <?php
		if ( is_front_page() ) {
		    ?>
		    <div class="wpl_carousel">
				<?php
				  if(is_active_sidebar('wpl_slider')){
				    dynamic_sidebar('wpl_slider');
				  }
				?>
				</div>
		    <?php
