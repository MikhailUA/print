...
(function() {
  ...
  Guillotine = (function() {
    function Guillotine(element, options) {
      ...
      this.setZoomStep = function(zoomStep) {
        this.op.zoomStep = zoomStep;
        this.zoomInFactor = 1 + zoomStep;
        this.zoomOutFactor = 1 / this.zoomInFactor;
      }
    ...
    Guillotine.prototype.listen = function() {
      return this.enabled && (this._trigger('listen'));
    };
  ...
  whitelist = ['rotateLeft', 'rotateRight', 'center', 'fit', 'zoomIn', 'zoomOut', 'instance', 'getData', 'enable', 'disable', 'remove', 'listen', 'setZoomFactor'];
