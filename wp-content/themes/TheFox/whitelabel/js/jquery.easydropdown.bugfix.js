...
(function(d) {
    function e() {
        this.isField = !0;
        this.keyboardMode = this.hasLabel = this.disabled = this.inFocus = this.down = !1;
        this.nativeTouch = !0;
    ...
    e.prototype = {
        ...
        init: function(a, c) {
            ...
            b.$optionsData = b.$select.find("option").data("dropfilter");
        ...
        render: function() {
            ...
            a.$active = d('<span class="selected" style="width:' + a.width + '">' + a.selected.title + "</span>").appendTo(a.$container);
            ...
            d.each(a.options, function() {
                a.$dropDown.append("<li " + (this.datafilter ? 'data-dropfilter=' + '"' + this.datafilter + '"' : "") + (this.selected ? ' class="active"' : "") + ">" + this.title + "</li>")
            });
